...
class AboutDialog(QDialog):
    def __init__(self, parent=None) -> None:
        ...
        if APP_LOGO_FILE.exists():
            ...
            logo.setPixmap(pixmap.scaled(74, 74, Qt.AspectRatioMode.KeepAspectRatio, Qt.TransformationMode.SmoothTransformation))
        ...
        legal_layout.setContentsMargins(18, 14, 18, 14)
