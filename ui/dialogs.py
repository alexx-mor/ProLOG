...
<p>Откройте вкладку <b>Производство</b>, найдите изделие и дважды щелкните по строке
либо нажмите <b>Открыть карточку производства</b>. В карточке можно добавить наблюдение, указать этап и готовность,
...
<p>В просмотрщике доступно сохранение одного оригинала. Фотографии выбранного события
или всего изделия можно пакетно выгрузить в выбранную папку. Существующие файлы
не перезаписываются, а недоступные оригиналы перечисляются в итоговом сообщении.</p>
<h3>Версия</h3>
<p>{APP_VERSION}</p>
"""
