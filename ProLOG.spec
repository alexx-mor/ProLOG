...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "production.module",
        "production.review_models",
        "production.review_repository",
        "production.review_service",
        "ui.production_inbox_controller",
        "ui.production_inbox_photo_viewer",
        "ui.production_inbox_widget",
    ],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
