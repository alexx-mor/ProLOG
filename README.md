...
Пути к основной базе ProLOG и базе WorkBot ведутся в справочнике «Базы данных».
Можно зарегистрировать существующий SQLite-файл на локальном сервере или в
сетевой папке. Новая основная база ProLOG подключается после перезапуска.
